...
## Derail - saw something cool

```Go
// This is a METHOD (belongs to the Status type)
func (s Status) String() string {
    ...
}

// This is a FUNCTION (standalone)
func SomethingElse(s Status) string {
    ...
}
```
